...
variable "esxi_software_version" {
  description = "(Optional) (Updatable) The ESXi software bundle to install on the ESXi hosts in the Cluster"
  type        = string
}
...
variable "sddc_id" {
  description = "The OCID of the SDDC that the Cluster belongs to."
  type        = string
  default     = null
}
