...
module "exa-infra" {
  source              = "git::https://github.com/oracle-devrel/terraform-oci-cd3.git//modules/database/exa-infra?ref=v2024.4.0"
...
module "exa-vmclusters" {
  ...
  source     = "git::https://github.com/oracle-devrel/terraform-oci-cd3.git//modules/database/exa-vmcluster?ref=v2024.4.0"
