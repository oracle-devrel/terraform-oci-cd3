...
module "alarms" {
  source = "git::https://github.com/oracle-devrel/terraform-oci-cd3.git//modules/managementservices/alarm?ref=v2024.4.0"
...
module "events" {
  source     = "git::https://github.com/oracle-devrel/terraform-oci-cd3.git//modules/managementservices/event?ref=v2024.4.0"
  depends_on = [module.notifications-topics]
...
module "notifications-topics" {
  source   = "git::https://github.com/oracle-devrel/terraform-oci-cd3.git//modules/managementservices/notification-topic?ref=v2024.4.0"
...
module "notifications-subscriptions" {
  source   = "git::https://github.com/oracle-devrel/terraform-oci-cd3.git//modules/managementservices/notification-subscription?ref=v2024.4.0"
...
module "service-connectors" {
  source = "git::https://github.com/oracle-devrel/terraform-oci-cd3.git//modules/managementservices/service-connector?ref=v2024.4.0"
