...
module "iam-compartments" {
  source   = "git::https://github.com/oracle-devrel/terraform-oci-cd3.git//modules/identity/iam-compartment?ref=v2024.4.0"
...
module "iam-groups" {
  ...
  source   = "git::https://github.com/oracle-devrel/terraform-oci-cd3.git//modules/identity/iam-group?ref=v2024.4.0"
  for_each = var.groups
...
module "iam-policies" {
  source   = "git::https://github.com/oracle-devrel/terraform-oci-cd3.git//modules/identity/iam-policy?ref=v2024.4.0"
...
module "iam-users" {
  source           = "git::https://github.com/oracle-devrel/terraform-oci-cd3.git//modules/identity/iam-user?ref=v2024.4.0"
  #depends_on       = [module.iam-groups]
  for_each         = var.users
...
module "iam-network-sources" {
  source       = "git::https://github.com/oracle-devrel/terraform-oci-cd3.git//modules/identity/iam-network-sources?ref=v2024.4.0"
...
module "groups" {
  ...
  source   = "git::https://github.com/oracle-devrel/terraform-oci-cd3.git//modules/identity/identity-domain-group?ref=v2024.4.0"
...
module "users" {
  source           = "git::https://github.com/oracle-devrel/terraform-oci-cd3.git//modules/identity/identity-domain-user?ref=v2024.4.0"
  #depends_on       = [module.iam-groups]
