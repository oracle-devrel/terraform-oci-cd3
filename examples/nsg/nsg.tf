...
module "nsgs" {
  source   = "git::https://github.com/oracle-devrel/terraform-oci-cd3.git//modules/network/nsg?ref=v2024.4.0"
...
module "nsg-rules" {
  source     = "git::https://github.com/oracle-devrel/terraform-oci-cd3.git//modules/network/nsg-rule?ref=v2024.4.0"
