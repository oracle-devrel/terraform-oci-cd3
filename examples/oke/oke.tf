...
module "clusters" {
  source                          = "git::https://github.com/oracle-devrel/terraform-oci-cd3.git//modules/oke/cluster?ref=v2024.4.0"
...
module "nodepools" {
  source                              = "git::https://github.com/oracle-devrel/terraform-oci-cd3.git//modules/oke/nodepool?ref=v2024.4.0"
...
module "virtual-nodepools" {
  source                      = "git::https://github.com/oracle-devrel/terraform-oci-cd3.git//modules/oke/virtual-nodepool?ref=v2024.4.0"
