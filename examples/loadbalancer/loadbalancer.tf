...
module "load-balancers" {
  ...
  source   = "git::https://github.com/oracle-devrel/terraform-oci-cd3.git//modules/loadbalancer/lb-load-balancer?ref=v2024.4.0"
...
module "hostnames" {
  source   = "git::https://github.com/oracle-devrel/terraform-oci-cd3.git//modules/loadbalancer/lb-hostname?ref=v2024.4.0"
...
module "certificates" {
  source   = "git::https://github.com/oracle-devrel/terraform-oci-cd3.git//modules/loadbalancer/lb-certificate?ref=v2024.4.0"
...
module "cipher-suites" {
  source   = "git::https://github.com/oracle-devrel/terraform-oci-cd3.git//modules/loadbalancer/lb-cipher-suite?ref=v2024.4.0"
...
module "backend-sets" {
  source   = "git::https://github.com/oracle-devrel/terraform-oci-cd3.git//modules/loadbalancer/lb-backend-set?ref=v2024.4.0"
  for_each = var.backend_sets != null ? var.backend_sets : {}
...
module "backends" {
  ...
  source     = "git::https://github.com/oracle-devrel/terraform-oci-cd3.git//modules/loadbalancer/lb-backend?ref=v2024.4.0"
  for_each   = var.backends != null ? var.backends : {}
...
module "listeners" {
  source   = "git::https://github.com/oracle-devrel/terraform-oci-cd3.git//modules/loadbalancer/lb-listener?ref=v2024.4.0"
...
module "path-route-sets" {
  depends_on = [module.backend-sets]
  source     = "git::https://github.com/oracle-devrel/terraform-oci-cd3.git//modules/loadbalancer/lb-path-route-set?ref=v2024.4.0"
...
module "rule-sets" {
  source   = "git::https://github.com/oracle-devrel/terraform-oci-cd3.git//modules/loadbalancer/lb-rule-set?ref=v2024.4.0"
...
module "routing-policies" {
  source   = "git::https://github.com/oracle-devrel/terraform-oci-cd3.git//modules/loadbalancer/lb-routing-policy?ref=v2024.4.0"
...
module "lbr-reserved-ips" {
  source   = "git::https://github.com/oracle-devrel/terraform-oci-cd3.git//modules/ip/reserved-public-ip?ref=v2024.4.0"
