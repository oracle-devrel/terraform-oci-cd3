...
module "network-load-balancers" {
  ...
  source                         = "git::https://github.com/oracle-devrel/terraform-oci-cd3.git//modules/networkloadbalancer/nlb?ref=v2024.4.0"
  for_each                       = var.network_load_balancers != null ? var.network_load_balancers : {}
...
module "nlb-listeners" {
  source                   = "git::https://github.com/oracle-devrel/terraform-oci-cd3.git//modules/networkloadbalancer/nlb-listener?ref=v2024.4.0"
...
module "nlb-backend-sets" {
  source                   = "git::https://github.com/oracle-devrel/terraform-oci-cd3.git//modules/networkloadbalancer/nlb-backendset?ref=v2024.4.0"
...
module "nlb-backends" {
  source = "git::https://github.com/oracle-devrel/terraform-oci-cd3.git//modules/networkloadbalancer/nlb-backend?ref=v2024.4.0"
