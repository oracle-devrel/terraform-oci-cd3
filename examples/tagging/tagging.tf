...
module "tag-namespaces" {
  source   = "git::https://github.com/oracle-devrel/terraform-oci-cd3.git//modules/governance/tagging/tag-namespace?ref=v2024.4.0"
...
module "tag-keys" {
  source   = "git::https://github.com/oracle-devrel/terraform-oci-cd3.git//modules/governance/tagging/tag-key?ref=v2024.4.0"
...
module "tag-defaults" {
  source   = "git::https://github.com/oracle-devrel/terraform-oci-cd3.git//modules/governance/tagging/tag-default?ref=v2024.4.0"
