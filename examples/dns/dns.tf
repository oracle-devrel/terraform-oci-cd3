...
module "dns-resolvers" {
  source = "git::https://github.com/oracle-devrel/terraform-oci-cd3.git//modules/network/dns/dns_resolver?ref=v2024.4.0"
...
module "dns-rrsets" {
  source     = "git::https://github.com/oracle-devrel/terraform-oci-cd3.git//modules/network/dns/rrset?ref=v2024.4.0"
...
module "dns-zones" {
  source              = "git::https://github.com/oracle-devrel/terraform-oci-cd3.git//modules/network/dns/zone?ref=v2024.4.0"
...
module "dns-views" {
  source              = "git::https://github.com/oracle-devrel/terraform-oci-cd3.git//modules/network/dns/view?ref=v2024.4.0"
