...
module "mts" {
  ...
  #Required
  source   = "git::https://github.com/oracle-devrel/terraform-oci-cd3.git//modules/storage/file-storage/mount-target?ref=v2024.4.0"
...
module "fss" {
  #Required
  source   = "git::https://github.com/oracle-devrel/terraform-oci-cd3.git//modules/storage/file-storage/fss?ref=v2024.4.0"
...
module "fss-export-options" {
  #Required
  source   = "git::https://github.com/oracle-devrel/terraform-oci-cd3.git//modules/storage/file-storage/export-option?ref=v2024.4.0"
...
module "fss-replication" {
  #Required
  source   = "git::https://github.com/oracle-devrel/terraform-oci-cd3.git//modules/storage/file-storage/fss-replication?ref=v2024.4.0"
