...
module "firewalls" {
  source                     = "git::https://github.com/oracle-devrel/terraform-oci-cd3.git//modules/security/firewall/firewall?ref=v2024.4.0"
  for_each                   = var.firewalls != null ? var.firewalls : {}
...
module "policies" {
  source         = "git::https://github.com/oracle-devrel/terraform-oci-cd3.git//modules/security/firewall/firewall-policy?ref=v2024.4.0"
...
module "services" {
  source                     = "git::https://github.com/oracle-devrel/terraform-oci-cd3.git//modules/security/firewall/service?ref=v2024.4.0"
...
module "service_lists" {
  source                     = "git::https://github.com/oracle-devrel/terraform-oci-cd3.git//modules/security/firewall/service-list?ref=v2024.4.0"
...
module "address_lists" {
  source                     = "git::https://github.com/oracle-devrel/terraform-oci-cd3.git//modules/security/firewall/address-list?ref=v2024.4.0"
...
module "applications" {
  source                     = "git::https://github.com/oracle-devrel/terraform-oci-cd3.git//modules/security/firewall/application?ref=v2024.4.0"
...
module "application_groups" {
  source                     = "git::https://github.com/oracle-devrel/terraform-oci-cd3.git//modules/security/firewall/application-group?ref=v2024.4.0"
...
module "url_lists" {
  source                     = "git::https://github.com/oracle-devrel/terraform-oci-cd3.git//modules/security/firewall/url-list?ref=v2024.4.0"
...
module "security_rules" {
  source                     = "git::https://github.com/oracle-devrel/terraform-oci-cd3.git//modules/security/firewall/security-rules?ref=v2024.4.0"
...
module "secrets" {
  source                     = "git::https://github.com/oracle-devrel/terraform-oci-cd3.git//modules/security/firewall/secret?ref=v2024.4.0"
...
module "decryption_profiles" {
  source                                = "git::https://github.com/oracle-devrel/terraform-oci-cd3.git//modules/security/firewall/decryption-profile?ref=v2024.4.0"
...
module "decryption_rules" {
  source                     = "git::https://github.com/oracle-devrel/terraform-oci-cd3.git//modules/security/firewall/decryption-rules?ref=v2024.4.0"
