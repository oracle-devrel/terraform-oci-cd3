...
module "vcns" {
  source   = "git::https://github.com/oracle-devrel/terraform-oci-cd3.git//modules/network/vcn?ref=v2024.4.0"
...
module "igws" {
  source   = "git::https://github.com/oracle-devrel/terraform-oci-cd3.git//modules/network/igw?ref=v2024.4.0"
...
module "ngws" {
  source   = "git::https://github.com/oracle-devrel/terraform-oci-cd3.git//modules/network/ngw?ref=v2024.4.0"
...
module "sgws" {
  source   = "git::https://github.com/oracle-devrel/terraform-oci-cd3.git//modules/network/sgw?ref=v2024.4.0"
...
module "hub-lpgs" {
  source   = "git::https://github.com/oracle-devrel/terraform-oci-cd3.git//modules/network/lpg?ref=v2024.4.0"
...
module "drgs" {
  #Required
  source   = "git::https://github.com/oracle-devrel/terraform-oci-cd3.git//modules/network/drg?ref=v2024.4.0"
...
module "drg-attachments" {
  #Required
  source   = "git::https://github.com/oracle-devrel/terraform-oci-cd3.git//modules/network/drg-attachment?ref=v2024.4.0"
...
module "default-dhcps" {
  #Required
  source   = "git::https://github.com/oracle-devrel/terraform-oci-cd3.git//modules/network/default-dhcp?ref=v2024.4.0"
...
module "custom-dhcps" {
  #Required
  source   = "git::https://github.com/oracle-devrel/terraform-oci-cd3.git//modules/network/custom-dhcp?ref=v2024.4.0"
...
module "security-lists" {
  source   = "git::https://github.com/oracle-devrel/terraform-oci-cd3.git//modules/network/sec-list?ref=v2024.4.0"
...
module "route-tables" {
  source = "git::https://github.com/oracle-devrel/terraform-oci-cd3.git//modules/network/route-table?ref=v2024.4.0"
...
module "drg-route-tables" {
  source   = "git::https://github.com/oracle-devrel/terraform-oci-cd3.git//modules/network/drg-route-table?ref=v2024.4.0"
...
module "drg-route-rules" {
  source     = "git::https://github.com/oracle-devrel/terraform-oci-cd3.git//modules/network/drg-route-rule?ref=v2024.4.0"
...
module "drg-route-distributions" {
  source   = "git::https://github.com/oracle-devrel/terraform-oci-cd3.git//modules/network/drg-route-distribution?ref=v2024.4.0"
...
module "drg-route-distribution-statements" {
  source   = "git::https://github.com/oracle-devrel/terraform-oci-cd3.git//modules/network/drg-route-distribution-statement?ref=v2024.4.0"
...
module "subnets" {
  source   = "git::https://github.com/oracle-devrel/terraform-oci-cd3.git//modules/network/subnet?ref=v2024.4.0"
...
module "vcn-log-groups" {
  source   = "git::https://github.com/oracle-devrel/terraform-oci-cd3.git//modules/managementservices/log-group?ref=v2024.4.0"
...
module "vcn-logs" {
  source   = "git::https://github.com/oracle-devrel/terraform-oci-cd3.git//modules/managementservices/log?ref=v2024.4.0"
